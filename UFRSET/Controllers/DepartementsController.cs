...
namespace UFRSET.Controllers
{
    public class DepartementsController : Controller
    {
        ...
        public DepartementsController(UFRSETContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DepartementId,NomDepartement")] Departement departement)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DepartementId,NomDepartement")] Departement departement)
        {
